...
docker tag demo-flask-app us-central1-docker.pkg.dev/cloud-run-project-432616/python-apps/demo-flask-app
docker push us-central1-docker.pkg.dev/cloud-run-project-432616/python-apps/demo-flask-app
gcloud run deploy demo-flask-app2 \
--image us-central1-docker.pkg.dev/cloud-run-project-432616/python-apps/demo-flask-app \
--region us-central1